...
const extraPassportValidator = require('./extraPassportValidator');

describe('Count how many valid passports in input', () => {
  it('Should return 2', () => {
...
iyr:2011 ecl:brn hgt:59in`;
    ...
    expect(passportValidator(input)).toBe(2);
  });
...
iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719`;
    expect(extraPassportValidator(input)).toBe(4);
  });
...
pid:3556412378 byr:2007`;
    ...
    expect(extraPassportValidator(input)).toBe(0);
